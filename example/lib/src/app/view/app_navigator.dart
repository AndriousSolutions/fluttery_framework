...
//         //   return pop;
//         // },
//         onGenerateRoute: appState?.onGenerateRoute,
//         onUnknownRoute: appState?.onUnknownRoute,
...
//     if (uri.path == AppRouterDelegate._currentConfiguration.path) {
...
//     return AppRoutePath.unknown(uri.path);
//   }
//
...
//         uri: Uri.parse(configuration.path!), state: configuration);
//   }
// }
//
...
//   AppRoutePath.unknown([String? path])
//       : path = path ?? '/404',
//         isUnknown = true,
//         isHomePage = false;
//
...
//     //   path = url;
//     // }
//     final path = WidgetsBinding.instance.platformDispatcher.defaultRouteName;
