      ...
      switch (animals[0]) {
        case 1:
          if (dog == limit) {
            ...
            images.add(RandomDog(key: GlobalObjectKey('dog$dog')));
          }
          break;
        case 2:
          if (cat == limit) {
            ...
            cat++;
            images.add(RandomCat(key: GlobalObjectKey('cat$cat')));
          }
          break;
        case 3:
          if (fox == limit) {
            ...
            fox++;
            images.add(RandomFox(key: GlobalObjectKey('fox$fox')));
          }
          break;
        case 4:
          if (bird == limit) {
            ...
            bird++;
            images.add(RandomBird(key: GlobalObjectKey('bird$bird')));
          }
          break;
      }
      cnt++;
